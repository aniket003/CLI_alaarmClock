/* 
    SUBMITTED BY: Aniket Singla
    EMAIL: singlaaniket13@gmail.com
    PHONE: 7009293856
    TO: Jalan Technologies Ltd.
*/
...
class Alarm {
    ...
    schedule(alarmClock) {
        ...
        // if (timeDifference < 0) {
        //     // Schedule for the next week if negative
        ...
        this.timeout = setTimeout(() => {
            if (this.isActive) {
                ...
                console.log(`\rAlarm ringing: ${this.time} on ${this.dayOfWeek}`);
                alarmClock.setSnoozeAlarm(this);
            }
        }, timeDifference);
    ...
    snooze(alarmClock) {
        console.log("made it here working fine")
...
class AlarmClock {
    ...
    selectAddAlarm() {
        this.rl.question("\nEnter alarm time 24 hour format (HH:MM:SS): ", (time) => {
            if(isValidTime(time)){
                ...
                this.rl.question("Enter day index: ", (dayIndex) => {
    ...
    // update alarmarray for alarm instance when snooze time added to alarm time
    ...
    setSnoozeAlarm(alarm) {
        this.rl.emit('line', 'esc')
        console.log("Options: 1. Snooze Alarm 2. Delete Alarm")
        this.rl.question('Enter choice:', (snoozeoption) => {
